                ...
                <Card className='bolus-card'>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'block' }}>
                            ...
                            <h6 style={{ color: 'black', fontSize: '15px', margin: '35% 0% 0% 20%' }}>Digitially Generated By <spam style={{ color: '#cb297b' }}>AgVa</spam> <spam style={{ color: '#444444' }}>HealthCare</spam></h6>
                        </div>
                    </div>
                </Card>
